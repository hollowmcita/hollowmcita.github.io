...
const teamSwiper = new Swiper(".team-swiper", {
    ...
    pagination: {
      ...
      bulletActiveClass: "team-swiper-pagination-bullet-active",
      bulletClass: "team-swiper-pagination-bullet",
      clickable: true,
    },
    on: {
      autoplayTimeLeft(swiper, timeLeft, percentage) {
        document.getElementById("#team-swiper-progress").style.setProperty("--progress", 1 - percentage);
      },
    },
  });